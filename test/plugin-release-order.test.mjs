...
test("candidate reconciliation reads npm, fetched tags, and the catalog", async () => {
  const invocations = [];
  ...
  assert.equal(result.candidateVersion, "0.2.4");
  assert.deepEqual(result.catalogVersions, ["0.2.4"]);
  assert.deepEqual(result.taggedVersions, ["0.1.0-alpha.3", "0.1.0", "0.1.1", "0.2.0", "0.2.1", "0.2.2", "0.2.3", "0.2.4"]);
  ...
  assert.deepEqual(invocations[2][1], [
    "show",
    "refs/release-check/tags/claude-v0.2.4:release/compatibility.json",
  ]);
});
