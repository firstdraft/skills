...
`f55edffc9e88924f9a4c95f41c4d0bc9b72422f8`, version `0.1.0-alpha.2`. The current reviewed 0.1.0 successor is
`d37d8b6775a0b97ce10bd651485bd308fed1dda2`, pinned separately below. The agent made two exact-byte pushes through
...
`precompile-semantic-read-back` is the local, no-command approval-gate fixture.
`compile-prepared-movie-catalog` is the executable product-journey fixture; its prompt supplies explicit approval of
the matching unchanged semantic read-back so the agent should not add a second confirmation ceremony.
