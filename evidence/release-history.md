# First Draft Skills 0.1.0 and 0.1.1 release history

> Historical reference. This page preserves the completed 0.1.0 and 0.1.1 chronology, point-in-time registry and
> catalog state, accepted documentation limitations, and the exact historical package-first rehearsal. Do not replay
> it as a current runbook. Use [`RELEASING.md`](../RELEASING.md) for current policy and
> [`evidence/README.md`](README.md) to select a dated observation.

This page was archived on 2026-08-13 from the former release runbook after the 0.1.1 work completed. Source-candidate
state at extraction is recorded separately in [`2026-08-13-release-state.json`](2026-08-13-release-state.json).
That snapshot is point-in-time evidence, not current authority; current candidate and catalog values belong to
`release/compatibility.json`, `.claude-plugin/marketplace.json`, and the current runbook.

The retained chronology below sometimes says “current” or “future” from the old runbook's point of view. Those words
are archival quotations of its operating context, not instructions or claims about present external state.
...
A separate [direct-package observation](2026-08-09-direct-package-0.1.0-check.md) records exact plugin 0.1.0
installation, strict validation, inline discovery, and bundled CLI 0.1.0 invocation without calling First Draft.
A dated [0.1.1 publication observation](2026-08-12-claude-plugin-0.1.1-release.md) binds the new protected
...
[direct-package observation](2026-08-12-direct-package-0.1.1-check.md) records exact 0.1.1 installation,
strict validation, inline discovery, bundled CLI 0.1.0, and wrapper preference without credentials or a service call.
A separate [public-install observation](2026-08-12-public-claude-code-plugin-0.1.1-install.md) records the
...
A dated [stable-tag promotion observation](2026-08-12-stable-npm-promotion.md) separately reconciles npm
...
The dated [staging Movie Catalog discovery smoke](2026-08-10-staging-movie-catalog-discovery-smoke.md)
...
A [dated release observation](2026-08-07-cli-0.1.0-release.md) records that CLI 0.1.0 was under `next` while
...
3. In isolated Claude state, the operator performed the direct-`next` package check. It resolved exact plugin 0.1.0,
   ...
   as release identity. A [dated direct-package observation](2026-08-07-direct-package-alpha3-check.md)
   records the same hardened procedure succeeding against public alpha.3 and its bundled CLI alpha.2. The separate
   [0.1.0 direct-package observation](2026-08-09-direct-package-0.1.0-check.md) records the required exact
...
6. After the public catalog promotion merged at exact catalog-promotion revision
   ...
   [public-install observation](2026-08-12-public-claude-code-plugin-0.1.1-install.md) records strict
...
[0.1.1 public-package direct-install check](2026-08-12-direct-package-0.1.1-check.md) and the exact promotion
...
pre-tag prerequisite. A [dated read-only observation](2026-08-07-npm-trusted-publisher.md) records the
